import { FileCoverageResult, PrInfo, TestFailuresResult } from './types';
...
function formatUncoveredLines(lines: number[], file: string, prInfo?: PrInfo): string {
