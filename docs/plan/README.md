...
3. Paste the stage prompt. Always append: *"Read docs/plan/README.md and the relevant phase file first. Follow the global decisions. Write tests for everything you add. Run the full test suite before finishing."*
